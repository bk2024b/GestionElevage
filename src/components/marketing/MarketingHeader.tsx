    ...
    <header className="sticky top-0 z-30 bg-paper/90 backdrop-blur border-b border-line">
      <div className="max-w-5xl mx-auto px-5 py-4 flex items-center justify-between">
        <Link href="/" className="flex items-center gap-2">
          <AppLogoMark size="sm" />
          <BrandName className="font-semibold text-sm" />
        </Link>
        ...
        <div className="flex items-center gap-2">
          <Link href="/login" className="tap text-sm text-ink px-3 py-2 rounded-control border border-line hidden sm:block">
            Connexion
          </Link>
          <ButtonLink href="/register" variante="primaire" className="text-sm px-4 py-2">
            Commencer
          </ButtonLink>
        </div>
      </div>
